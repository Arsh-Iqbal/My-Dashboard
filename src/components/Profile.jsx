      ...
      <div className="container max-w-4xl mx-auto text-center z-10 space-y-4 md:space-y-6">
        <div className="flex flex-col items-center justify-center space-y-3 md:space-y-4 mt-16">
          ...
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
            ...
            <span className="text-primary opacity-0 animate-fade-in-delay-1">{" "}Arsh</span>
            <span className="text-gradient ml-2 opacity-0 animate-fade-in-delay-2">{" "}Iqbal</span>
          </h1>
        <p className="text-center max-w-2xl mx-auto text-muted-foreground opacity-100 px-2 md:px-0">
  I’m passionate about developing well-rounded web applications that deliver excellent user experiences.
  As a full-stack developer, I handle both the front-end and back-end, ensuring seamless functionality and polished design from start to finish.
</p>
          <div className="opacity-0 animate-fade-in-delay-4 text-muted-foreground text-sm md:text-base space-y-1">
            <p>Email: <a href="mailto:iqbalarsh54@gmil.com" className="text-primary hover:underline">iqbalarsh54@gmail.com</a></p>
            <p>Phone: <a href="#" className="text-primary hover:underline">8090010660</a></p>
          </div>
