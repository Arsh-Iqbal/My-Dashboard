        ...
        <div className="mb-16 space-y-6">
          ...
          <div className="bg-card p-6 rounded-lg shadow-md">
            <p className="text-lg font-semibold">
              BCA – Chandigarh University 2022-2025
            </p>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-card p-6 rounded-lg shadow-md">
            ...
            <ul className="list-disc ml-5 space-y-2 text-base text-foreground">
              <li>
                Developed a full stack school portal with real-time messaging,
                live classes (Google Meet API integration), and CRUD operations
                (homework, lesson plans, user data).
              </li>
              <li>
                Implemented JWT authentication for secure user access and API
                protection.
              </li>
              <li>
                Built scalable APIs with Node.js/Express.js and managed
              ...
              <li>
                Conducted comprehensive testing, debugging, and optimization.
              </li>
              <li>
                Collaborated with team members to meet goals and deadlines.
              </li>
            </ul>
          </div>
        </div>
